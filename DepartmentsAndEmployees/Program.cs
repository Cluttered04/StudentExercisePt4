    ...
    class Program
    {
        ...
        public static void PrintEmployeeReport(string title, List<Employee> employees)
        {
            ...
            foreach(Employee singleEmployee in employees){
                ...
                {
                    Department employeeDepartment = singleEmployee.Department;
                    Console.WriteLine($"{singleEmployee.FirstName} {singleEmployee.LastName} {employeeDepartment.DeptName}");
                } else
                {
                    Console.WriteLine($"{singleEmployee.FirstName} {singleEmployee.LastName}");
                }
